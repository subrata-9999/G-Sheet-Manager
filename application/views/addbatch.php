                                ...
                                <div class="">
                                    <div class="">
                                        ...
                                        <div class="modal-body">
                                            <form action="<?= base_url('index.php/batch/add_batch'); ?>" method="post">

                                                <!-- <div class="md-3" style="display: none; padding-bottom: 16px;">
                                                    <label class="form-label">Add Batch Id:</label><br>
                                                    <input type="text" class="form-control" name="batchid" id="batchhid" placeholder="Add Batch Id">
                                                </div> -->

                                                <div class="mb-3">
                                                    <label class="form-label">Add Batch Name:</label>
                                                    <input type="text" name="batchname" id="batchname" placeholder="Batch Name" class="form-control" required>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="startdate" class="form-label">Starting Date:</label>
                                                    <input type="date" name="startdate" id="startdate" class="form-control" placeholder="Starting Date" required>
                                                </div>
                                                <label for="" class="form-label">Time:</label>
                                                <div class="mb-3">
                                                    <label class="form-label">From:</label>
                                                    <input type="time" name="batchstart" id="batchstart" placeholder="Batch string time" class="form-control" required>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="startdate" class="form-label">To:</label>
                                                    <input type="time" name="batchend" id="batchend" class="form-control" placeholder="Batch end time" required>
                                                </div>
                                                ...
                                                <div class="dropdown" data-control="checkbox-dropdown">
                                                    ...
                                                    <div class="dropdown-list">
                                                        ...
                                                        <label class="dropdown-heading">COURSES</label>
                                                        <?php foreach ($course as $data) : ?>
                                                            <label class="dropdown-option">
                                                                <input type="checkbox" name="dropdown-group" value="<?= $data['course_name']; ?>" />
                                                                <?= $data['course_name']; ?>
                                                            </label>
                                                        <?php endforeach; ?>
                                                ...
                                                <input style="display: none;" type="text" name="batchcourse" id="batchcourse" class="form-control" required>
    ...
    <script>
        ...
        (function($) {
            ...
            CheckboxDropdown.prototype.updateStatus = function() {
                ...
                //storing the value in the input field batchcourse(hidden)
                document.getElementById("batchcourse").value = target_employee;
            };
