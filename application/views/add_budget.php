                                ...
                                <div class="">
                                    <div class="">
                                        ...
                                        <div class="modal-body">
                                            <form action="<?= base_url('index.php/expenses/add_expenses'); ?>" method="post">
                                                <div class="mb-3">
                                                    <label class="form-label">Select Expenses Category:</label><br>
                                                    <select class="form-control" name="budgetType" id="budgetType">
                                                        <?php
                                                        $options = explode(',', $expenses_budget[0]['options_list']);
                                                ...
                                                <div class="md-3" style="padding-bottom: 16px;">
                                                    <label class="form-label">Add Expenses Category:</label><br>
                                                ...
                                                <div class="mb-3" style="display: none;">
                                                    ...
                                                    <input type="text" name="prevCategory" id="prevCategory" class="form-control" readonly value="<?php echo $expenses_budget[0]['options_list']; ?>">
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    <label for="budgetName" class="form-label">Expenses Name:</label>
                                                    <input type="text" name="budgetName" class="form-control" placeholder="Expenses Name" required>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="budgetRemarks" class="form-label">Expenses Remarks:</label>
                                                    <textarea name="budgetRemarks" class="form-control" placeholder="Expenses Remarks" required></textarea>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="budgetAmount" class="form-label">Expenses Amount:</label>
