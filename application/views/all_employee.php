                                        ...
                                        <?php foreach ($all_employees as $employee) : ?>
                                            <tr>
                                                <?php if ($employee['user_type'] == '1') { ?>
                                                    ...
                                                    <td>
                                                        <a href="<?= base_url('index.php/user/editMember/' . $employee['id']) ?>" class="btn btn-primary">Edit</a>
                                                        <a href="<?= base_url('index.php/user/deleteMember/' . $employee['id']) ?>" class="btn btn-danger">Delete</a>
                                                    </td>
                                                <?php } else { ?>
                                                <?php } ?>
                                            </tr>
