...
<head>
    ...
    <title>Sheet-<?php echo $sheet['id']; ?></title>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <!-- edit Task Modal -->
                                <div id="editTaskModal" class="" style="display: block;">
                                    <div class="">
                                        <div class="">
                                            <!-- Modal Header -->
                                            ...
                                            <div class="modal-body">
                                                <form action="" method="post">
                                                    <div class="mb-3">
                                                        <h4>Sheet Title</h4>
                                                        <label for="viewtitle" class="form-label"><?php echo $sheet['title'] ?></label>
                                                    </div>

                                                    <div class="mb-3">
                                                        <h4>Sheet Description</h4>
                                                        <label for="viewdescription" class="form-label"><?php echo $sheet['description'] ?></label>
                                                    </div>
                                                    <div class="mb-3">
                                                        <h4>Sheet Link</h4>
                                                        <label for="viewsheet_link" class="form-label"><?php echo $sheet['link']; ?></label>
                                                    </div>
                            ...
                            <input type="text" name="assigned_by" value="<?php echo $user_id; ?>" class="form-control" required>
                                                    ...
                                                    <div class="mb-3">
                                                        <h4>Sheet Assigned Date</h4>
                                                        <label for="viewdeadline" class="form-label"><?php echo $sheet['assigned_date'] ?></label>
                                                    </div>
                                                    <?php
                                                    ...
                                                    <div class="mb-3">
                                                        <h4>Sheet Assigned Member</h4>
                                                        <label for="viewdeadline" class="form-label"><?php foreach ($result_member as $member) {
                                                                                                            echo $member['name'] . '<br>';
                                                                                                        } ?></label>
                                                    </div>
                                                </form>
