                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php foreach ($all_managers as $manager) : ?>
                                            <tr>
                                            <?php if ($manager['user_type'] == '1') { ?>
                                                    <td><?php echo $manager['name']; ?></td>
                                                    <td><?php echo $manager['username']; ?></td>
                                                    <td>
                                                        <a href="<?= base_url('index.php/user/editMember/' . $manager['id']) ?>" class="btn btn-primary">Edit</a>
                                                        <a href="<?= base_url('index.php/user/deleteMember/' . $manager['id']) ?>" class="btn btn-danger">Delete</a>
                                                    </td>
                                                <?php } else { ?>
                                                <?php } ?>
                                            </tr>
