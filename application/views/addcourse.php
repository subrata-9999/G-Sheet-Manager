                                ...
                                <div class="">
                                    <div class="">
                                        ...
                                        <div class="modal-body">
                                            <form action="<?= base_url('index.php/course/add_course'); ?>" method="post">
                                                <div class="mb-3">
                                                 ...
                                                 <div class="mb-3">
                                                    <label for="startdate" class="form-label">Course Fees:</label>
                                                    <input type="number" name="coursefees" id="coursefees" class="form-control" placeholder="Course fees" required>
                                                </div>
