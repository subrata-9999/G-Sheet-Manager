...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div id="addEmployeeModal" class="" style="display: block;">
                                <div class="">
                                    <div class="">
                                        <!-- Modal Header -->
                                        ...
                                        <div class="modal-body">
                                            <form action="<?= base_url('index.php/task/updateMember/' . $details_of_user['id']) ?>" method="post">
                                                <div class="mb-3">
                                                ...
                                                <div class="dropdown" style="">
                                                    <label class="dropdown">Role</label>
    ...
    <script>
        var username = '<?php echo $details_of_user["username"]; ?>';
        var name = '<?php echo $details_of_user["name"]; ?>';
        var password = '<?php echo $details_of_user["password"]; ?>';
        var role = '<?php echo $details_of_user["role"]; ?>';
